...
###################################################################################################################################
#get data
train = pd.read_csv('../input/train_blank_words.csv')#[:10000]
test = pd.read_csv('../input/test_blank_words.csv')#[:10000]
...
tokenizer.fit_on_texts(list(train["w1_new"])+list(test["w1_new"])+list(train["w2_new"])+list(test["w2_new"]))
column="w1_new"
...
print(score)
name="esim_blank_same_%s"%str(round(score,6))
print(score)
t_p = pd.DataFrame()
t_p[name]=te_pred
